...
# знания языка – баллу за экзамен выше 80. Сохранить полученный результат в массив advanced. В
# заданиях 8-10 нужно работать с массивом advanced.
...
print(np.ndim(advanced))

# Задание 9

print(np.shape(advanced))
...
# Задание 11
# На основе исходного массива scores создать булев массив sto, где True соответствует баллам за
# экзамен, равным 100, а False – всем остальным баллам.
