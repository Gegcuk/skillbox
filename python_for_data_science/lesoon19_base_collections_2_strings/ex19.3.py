def ex19_2_1():
    ...
    words = input("Enter your 3 words: ").split()
    text = input("Enter your text")
    word_1 = text.count(words[0])
    word_2 = text.count(words[1])
    word_3 = text.count(words[2])
...
def ex19_2_2():
    ...
    print(' '.join(input("Enter grandma`s msg: ").split()))
...
def ex19_2_3():
    ...
    #
    # Пример:
    # Введите шаблон поздравления, в шаблоне можно использовать конструкцию {name} и {age}: С днём рождения, {name}!
    # С {age}-летием тебя!
    #
    ...
    grats_template = input("Enter your template with {name} and {age}: ")
    names = input("Enter names divided by ',': ").split(", ")
    ages = input("Enter ages: ").split()
    for i in range(len(names)):
        print(grats_template.format(name=names[i], age=ages[i]))
    people = [', '.join([names[i_man], str(ages[i_man])])
