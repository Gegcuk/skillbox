...
def ex21_2_3():
    ...
    def return_odds(user_text):
        if isinstance(user_text, tuple) or isinstance(user_text, list) or isinstance(user_text, dict):
            return [value for key, value in enumerate(list(user_text)) if key % 2 == 0]
        else:
            return [value for key, value in enumerate(user_text) if key % 2 == 0]

    print(return_odds('О Дивный Новый мир!'))
    print(return_odds([100, 200, 300, 'буква', 0, 2, 'а']))
